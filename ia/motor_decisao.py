        ...
        self.regras = {
            ...
            "inss": {
                "palavras": ["inss", "benefício", "beneficio", "aposentadoria",
                             "aposentar", "me aposentar", "quero aposentar",
                             "quero me aposentar", "me aposentei", "aposentei",
                             "aposentado", "aposentada", "me aposentar",
                             "auxílio doença", "auxilio doenca", "auxílio-doença",
                             "afastado", "afastamento", "perícia", "pericia",
                             "bpc", "loas", "previdência social", "previdencia social",
                             "tempo de contribuição", "contribuição previdenciária",
                             "contribuicao previdenciaria", "seguro desemprego",
