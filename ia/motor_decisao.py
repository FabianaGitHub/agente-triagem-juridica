        ...
        self.regras = {
            ...
            "familia": {
                "palavras": ["divórcio", "divorcio", "separação", "separacao", "guarda",
                             ...
                             "alimentos", "alimento", "alimentar", "alimentícia", "alimenticia",
                             ...
                             "pai não paga", "pai nao paga", "sem pagar",
                             "mãe", "mae", "paternidade", "maternidade",
                             "visita", "visitação", "visitacao", "custódia", "custodia",
                             "adoção", "adocao", "tutor", "tutela"],
                "prioridade": 2,
